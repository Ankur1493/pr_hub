  ...
  return (
    <div className="flex justify-around w-screen py-4  fixed bottom-0 border-t-red-200 border-t">
      ...
      <div className="flex w-[10%] justify-around">
        <a href="https://linkedin.com/in/ankursharma14"><Linkedin color="black" /></a>
        <a href="https://github.com/ankur1493"><Github color="black" /></a>
        <a href="https://twitter.com/ankursharma1493"><Twitter color="black" /></a>
      </div>
    </div>
  )
}
